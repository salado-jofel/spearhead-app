      ...
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="flex flex-col leading-none mb-2">
            <span className="text-2xl font-black tracking-tighter uppercase">Spearhead</span>
            <span className="text-[10px] tracking-[0.4em] text-emerald-400/80 uppercase font-medium">Medical</span>
          </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-[10px] text-slate-600 italic">
            This page is intended for prospective independent sales representatives only.
          </p>
        </div>
      </div>
    </footer>
