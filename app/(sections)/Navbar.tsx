      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col leading-none">
            <span className="text-lg font-black tracking-tighter text-white uppercase">Spearhead</span>
            <span className="text-[10px] tracking-[0.2em] text-emerald-400/80 uppercase font-medium">Medical</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button variant="outline" className="border-white/20 bg-white/5 text-white hover:bg-white/10 rounded-full h-9 px-5 gap-2 backdrop-blur-md">
